...
--  │        │
--  │        └── table name
--  └── schema name (created by changeset 001)
...
--
-- Rollback order matters — Liquibase rolls back in REVERSE order:
--   Applied:   001 (schema) → 002 (table)
...
--   Liquibase already knows the changeset was applied (it's in DATABASECHANGELOG),
